...
1. Fundamentos de Ciencias de la Computación
    ...
    2. Matemáticas Discretas y Lógica
        1. Sistemas Numéricos y Representación de Datos
            ...
            5. Detección de *overflow* y *carry* en ALU (visión)
            6. Codificación de caracteres: ASCII/Unicode (UTF-8 preferente)
            7. Conversión entre bases (división sucesiva/productos repetidos)
            8. Números especiales IEEE (±0, subnormales, ±∞, NaN) — uso práctico
        2. Teoría de Conjuntos
            1. Operaciones básicas (∪, ∩, \, Δ) y leyes algebraicas
            2. Producto cartesiano y construcción de relaciones n-arias
        ...
        3. Lógica Proposicional y de Predicados formales
            ...
            4. CNF/DNF y uso para SAT/automatización
            5. Noción de satisfacibilidad y modelos; resolución proposicional
            6. Traducción bidireccional entre lenguaje natural y fórmulas
        4. Metodología de la Demostración
            1. Prueba directa y por casos
            2. Contraposición y contradicción (*reductio*)
            3. Inducción simple y fuerte (equivalentes)
            4. Invariantes/variantes de lazo para corrección de algoritmos
            5. Existencia y unicidad (técnicas estándar)
        5. Combinatoria y Principios de Conteo
            1. Reglas de suma y producto; *counting* básico
            2. Permutaciones/combinaciones (con y sin repetición)
            3. Binomio de Newton y coeficientes binomiales
            4. Inclusión–exclusión (PIE) con ejemplos canónicos
            5. Principio del palomar (Dirichlet) aplicado
            6. Doble conteo e inyecciones/biyeciones útiles
        6. Probabilidad Discreta
            1. Espacios muestrales finitos; eventos y reglas
            2. Probabilidad condicional y Bayes básico
        ...
        9. Recurrencias y Funciones Generatrices
            ...
            4. Iteración/sustitución y telescoping
            5. OGF/EGF: definición y operaciones básicas
        ...
        14. Cadenas de Markov y Caminatas Aleatorias (Discretas)
            ...
            6. Mezcla (mixing time) y ergodicidad (noción)
            7. PageRank como vector estacionario (formulación lineal)
    3. Autómatas y modelos de cómputo
    ...
    6. Sistemas operativos (procesos, hilos, memoria, planificación)
    ...
    7. Virtualización y contenedorización
    ...
    13. Computación paralela y vectorizada
    ...
    14. Computación en la nube y edge computing
    ...
    16. Balanceo de carga y redes de distribución de contenido (CDN)
...
2. Análisis y Diseño de software
    1. Procesos de ingeniería de software
...
5. Desarrollo frontend, interfaces gráficas y usabilidad
